...
### ネタバレカウント機能
ネタバレカウント機能とは、アニメ投稿者ではないユーザーが詳細ページを見て、ネタバレだと思ったアニメ投稿に対してカウントを増やすことで、まだ見ていないユーザーは一覧ページやマイページ、検索ページにて詳細ページにネタバレがあるかどうか分かるようになります。また、アニメ投稿者はカウントの数を見て、自分のアニメ投稿にネタバレがあるかどうかが分かるようになります。さらに、アニメ投稿者が編集を行うと「編集済み」と表示されるので、そのアニメ投稿の詳細ページを見たユーザーがもう1度見たときに、ネタバレが無くなっていればカウントを減らすことで、ネタバレが無くなったことがわかるようになります。  
  
ログイン状態かつ自分の投稿でなければ、投稿されたアニメの詳細ページで「ネタバレ！」ボタンをクリックし、ネタバレカウントを増やすことができます。また、増やした状態でもう一度「ネタバレ！」ボタンをクリックするとネタバレカウントを減らすことができます。  
