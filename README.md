...
# アプリケーションを作成した背景
面白いアニメを探そうとしたときに、そのアニメのどこが良いのか、どんな人におすすめなのかをネタバレ無しで知りたいと思いました。なので、ネタバレを避けたいという人のために、他の人にネタバレ無しでおすすめしてもたえたり、おすすめしてもらった人にスレッドのような形式で質問できるアプリケーションを開発することにしました。
...
### アニメ編集機能
ログイン状態かつ自分の投稿ならば、編集ページへ遷移することができます。  
...
### ネタバレカウント機能
ログイン状態かつ自分の投稿でなければ、投稿されたアニメに対して「ネタバレ！」ボタンをクリックし、ネタバレカウントを増やすことができます。また、増やした状態でもう一度「ネタバレ！」ボタンをクリックするとネタバレカウントを減らすことができます。  
...
・現段階で、投稿されたアニメにコメントがあると投稿されたアニメが削除できなくなる不具合が発生しているので、コードの修正を行います。  

・ActiveStorageを使用し、画像を表示させているが、元の画像の大きさによって、画像の大きさが異なってしまうので、全て統一します。  
